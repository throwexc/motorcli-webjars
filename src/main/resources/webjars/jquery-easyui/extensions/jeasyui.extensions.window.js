...
(function ($, undefined) {
    ...
    $.fn.window = function (options, param) {
        ...
        return this.each(function () {
            var jq = $(this), hasInit = $.data(this, "window") ? true : false,
                opts = hasInit ? options : $.extend({},defaults ,$.fn.window.parseOptions(this), $.parser.parseOptions(this, [{
    ...
    var defaults = $.fn.window.extensions.defaults
        ...
        //enableHeaderContextMenu: true,//jgc del
